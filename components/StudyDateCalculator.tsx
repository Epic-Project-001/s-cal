...
export default function StudyDateCalculator() {
  ...
  return (
    ...
    <div className="mx-auto max-w-[431px] px-4 w-full flex my-10 lg:my-20 flex-col items-center">
      ...
      <p className="text-sm text-gray-500 text-center text-balance mt-4">Select the study Phase and enter the start date for that Phase. {" "}
    ...
    <p className="text-sm text-gray-500 text-center text-balance mb-8">
          <strong>Disclaimer:</strong> This study visit calculator is provided as a
          supplementary tool to assist with scheduling in accordance with the study
          Protocol (and any Amendments thereto). It is intended for convenience only
          and does not replace, override, or supersede the Protocol or associated study
          documents. In the event of any discrepancies between this tool and the
          Protocol, the Protocol and sponsor guidance take precedence. Users are
          responsible for ensuring compliance with the Protocol and for verifying all
          visit schedules accordingly. Based on protocol 221794 dated 20 Mar 2025.
        </p>
    </div>
  );
}
